 ...
 */
const AggressiveCTA = ({ onClick, text = "Start Getting Inbound Leads", subtext = "Answer a couple quick questions and I’ll show you how this works", className = "" }) => (
  <div className="flex flex-col items-start gap-4">
    <div className="relative group w-full sm:w-auto">
      ...
      >
        <span className="relative flex items-center gap-4 tracking-tighter uppercase text-left leading-none">
          {text}
          <ArrowRight className="w-6 h-6 md:w-8 md:h-8 group-hover:translate-x-2 transition-transform text-[#5B5FFF]" strokeWidth={4} />
        </span>
      </button>
    </div>
    {subtext && <p className="text-slate-400 text-[10px] md:text-xs font-black uppercase tracking-[0.4em] ml-2">{subtext}</p>}
  </div>
);
    ...
    <nav className={`fixed top-0 w-full z-[100] transition-all duration-500 px-4 sm:px-12 ${isScrolled ? 'py-4' : 'py-8'}`}>
      <div className={`max-w-7xl mx-auto flex items-center justify-between transition-all duration-500 rounded-3xl border px-6 py-4 ${
        ...
        <div className="flex items-center gap-2 cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
          ...
          <span className="font-black text-xl md:text-2xl tracking-tighter uppercase text-white">Inbound Lead System<span className="text-[#5B5FFF]">™</span></span>
        </div>
  ...
  <section className="relative min-h-screen flex items-center pt-32 pb-24 px-6 overflow-hidden bg-[#0B1220]">
    ...
    <div className="max-w-7xl mx-auto w-full relative z-10">
      <div className="grid lg:grid-cols-12 gap-12 items-center text-left">
        <div className="lg:col-span-10 xl:col-span-9 text-left">
          <Reveal delay={100} direction="left">
            <div className="inline-flex items-center gap-3 px-4 py-2 mb-8 text-[10px] font-black tracking-[0.4em] uppercase bg-[#5B5FFF]/10 text-[#5B5FFF] border border-[#5B5FFF]/30 rounded-full backdrop-blur-md">
               This shows you how to get people reaching out to YOU instead
            </div>
          </Reveal>
          
          <Reveal delay={300} direction="left">
            <h1 className="text-6xl md:text-[9rem] lg:text-[11rem] font-[1000] text-white leading-[0.85] tracking-[-0.08em] uppercase text-left mb-10">
              Stop Chasing <br />
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start mb-16 text-left">
            <Reveal delay={500} direction="left" width="auto">
              <div className="w-1 h-32 bg-gradient-to-b from-[#5B5FFF] to-transparent hidden md:block mt-2" />
            </Reveal>
            ...
            <Reveal delay={600} direction="left">
              <div className="max-w-2xl space-y-6 text-left">
                <p className="text-2xl md:text-4xl text-slate-300 font-medium leading-[1.1] tracking-tight">
                  ...
                  <span className="text-white font-black italic">this will make sense.</span>
                </p>
                <p className="text-lg md:text-2xl text-slate-500 font-bold uppercase tracking-widest leading-tight">
                  This system brings high-value <span className="text-white shadow-[0_0_20px_rgba(255,255,255,0.3)] px-1 font-black">LEADS</span> to you daily — No chasing, No cold DMs, No begging friends and family.
                </p>
              </div>
            </Reveal>
          </div>
...
const CallOut = () => (
  <section className="py-32 bg-[#5B5FFF] relative overflow-hidden">
    ...
    <div className="max-w-6xl mx-auto px-6 relative z-10 text-center">
      <Reveal>
        <h2 className="text-5xl md:text-8xl font-[1000] text-[#0B1220] uppercase tracking-[-0.06em] mb-16 leading-none">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {[
          ...
          <Reveal key={i} delay={i * 200}>
            <div className="bg-[#0B1220] p-12 rounded-[2.5rem] shadow-2xl border border-white/10 group hover:bg-[#0B1220]/90 transition-all duration-500">
  ...
  <section className="py-40 bg-[#0F172A] relative overflow-hidden">
    <div className="max-w-7xl mx-auto px-6 relative z-10">
      <div className="text-center mb-24">
        <Reveal>
            <h2 className="text-5xl md:text-8xl font-[1000] text-white uppercase tracking-[-0.06em] mb-6">
                Chasing vs <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#5B5FFF] to-[#8E7CFF]">Attracting</span>
            </h2>
            <p className="text-slate-400 text-lg md:text-2xl font-medium tracking-tight uppercase tracking-widest">Why most people struggle to get leads</p>
        </Reveal>
      </div>
        ...
        <Reveal direction="left" delay={200}>
            <div className="h-full bg-white/5 border border-white/10 p-10 md:p-16 rounded-[3rem] space-y-10 border-l-4 border-l-red-500/50">
                <div className="flex items-center gap-6">
                    ...
                    <h3 className="text-3xl md:text-4xl font-[1000] text-white uppercase tracking-tighter italic"><span className="text-red-500">CHASING</span> is Interruption</h3>
                </div>
        ...
        <Reveal direction="right" delay={400}>
            <div className="h-full bg-gradient-to-br from-[#5B5FFF]/10 to-transparent border border-[#5B5FFF]/20 p-10 md:p-16 rounded-[3rem] space-y-10 border-r-4 border-r-[#5B5FFF]">
                <div className="flex items-center gap-6">
                    ...
                    <h3 className="text-3xl md:text-4xl font-[1000] text-white uppercase tracking-tighter italic"><span className="text-[#5B5FFF]">ATTRACTING</span> is Intent</h3>
                </div>
                <div className="space-y-6 text-lg md:text-xl text-slate-400 font-medium leading-relaxed">
      ...
      <Reveal delay={600}>
        <div className="mt-24 text-center max-w-4xl mx-auto p-12 bg-white/5 rounded-[2.5rem] border border-white/5">
            <p className="text-2xl md:text-4xl text-white font-black uppercase tracking-tighter leading-tight">
...
const PainReality = () => (
  <section className="py-40 bg-slate-50 border-y border-slate-200 text-center">
    <div className="max-w-7xl mx-auto px-6">
        <Reveal>
            <span className="text-[#5B5FFF] font-black uppercase tracking-widest text-sm mb-10 block">The Hard Truth</span>
            <h2 className="text-5xl md:text-[9rem] font-[1000] uppercase tracking-tighter leading-[0.8] text-[#0F172A] mb-12">
              Most business owners <span className="text-red-600 block">STAY STUCK & BROKE</span> 
            </h2>
            <p className="text-2xl md:text-5xl font-black text-slate-800 tracking-tighter mb-20">
               Because they rely on <span className="italic">"posting and hoping."</span>
            </p>
        </Reveal>
            ...
            {[
                ...
                <Reveal key={i} delay={i * 100}>
                    <div className="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm h-full">
                        <h4 className="text-2xl font-black uppercase text-[#0F172A] mb-4">{item.title}</h4>
    ...
    <section className="py-48 bg-[#0B1220] relative">
        <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-32">
                <Reveal>
                    <span className="inline-block mb-8 text-xs font-black tracking-[0.5em] uppercase text-[#5B5FFF] px-6 py-2 border border-[#5B5FFF]/20 rounded-full">The Solution</span>
            ...
            <div className="grid md:grid-cols-3 gap-16 relative text-center">
                {[
                    ...
                    <Reveal key={i} delay={i * 200}>
                        <div className="group p-8 rounded-3xl hover:bg-white/5 transition-colors duration-500 border border-transparent hover:border-white/5 h-full">
                            ...
                            <h3 className="text-3xl font-[1000] uppercase tracking-tighter text-white mb-6 leading-none">{item.title}</h3>
            ...
            <div className="mt-32 flex justify-center">
                <AggressiveCTA onClick={onTrigger} text="Start Getting Inbound Leads" />
            </div>
        </div>
    </section>
);
...
const FinalCTA = ({ onTrigger }) => (
    <section id="cta" className="py-56 md:py-80 bg-white relative overflow-hidden text-center">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-gradient-to-b from-[#5B5FFF]/10 to-transparent -z-10" />
    </section>
);
  ...
  <footer className="py-24 px-6 bg-[#0B1220] text-white border-t border-white/5">
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-16">
      ...
      <div className="text-[11px] text-slate-600 font-bold uppercase tracking-[0.3em] text-center md:text-right">
        ...
        Helping marketers get leads without chasing.
      </div>
    </div>
  </footer>
);
